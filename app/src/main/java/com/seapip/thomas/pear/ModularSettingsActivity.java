...
public class ModularSettingsActivity extends SettingsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProviderInfoRetriever.retrieveProviderInfo(
                ...
                new ComponentName(getApplicationContext(), ModularWatchFaceService.class),
                ModularWatchFaceService.COMPLICATION_IDS
        );
        ModularWatchFaceService.SETTINGS_MODE = 3;
    }
    ...
    public void setSettingsMode(boolean mode) {
        ModularWatchFaceService.SETTINGS_MODE = mode ? 3 : 1;
    }
